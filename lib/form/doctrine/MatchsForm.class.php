...
class MatchsForm extends BaseMatchsForm {
    ...
    public function configure() {
        ...
        $supportedRoundFormats = array("16" => "MR16", "15" => "MR15", "12" => "MR12", "8" => "MR8", "5" => "MR5", "3" => "MR3");
        ...
        $this->widgetSchema["config_ot"]->setDefault(sfConfig::get("app_default_overtime_enable", true));
